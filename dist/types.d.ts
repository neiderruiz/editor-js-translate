...
export type EditorBlock = Block<TextData> | Block<ListData> | Block<ImageData> | Block<WarningData> | Block<QuoteData> | Block<ChecklistData> | Block<TableData> | Block<LinkToolData>;
